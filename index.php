...
<nav class="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200 dark:border-white/5 transition-colors">
    <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="/MIIAUDITOPS/" class="flex items-center gap-2">
            <div class="h-[52px] w-[208px] overflow-hidden relative">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="#pricing" class="hidden md:inline-flex items-center gap-1.5 text-sm font-semibold text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 transition-colors">
...
<section id="features" class="py-24 relative">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl font-black text-slate-800 dark:text-white mt-3">Seven Powerful Modules. One Unified Control Center.</h2>
...
<section id="pricing" class="py-24 relative">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl font-black text-slate-800 dark:text-white mt-3">Simple, Transparent Pricing</h2>
